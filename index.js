...
$root.OutputCoding = (function() {
  ...
  OutputCoding.verify = function verify(message) {
    ...
    if (message.container != null && message.hasOwnProperty('container'))
      if (!$util.isString(message.container)) return 'container: string expected'
    if (message.codec != null && message.hasOwnProperty('codec'))
      if (!$util.isString(message.codec)) return 'codec: string expected'
    if (message.targetSampleRate != null && message.hasOwnProperty('targetSampleRate'))
      if (!$util.isInteger(message.targetSampleRate)) return 'targetSampleRate: integer expected'
    if (message.targetBitRate != null && message.hasOwnProperty('targetBitRate'))
      if (!$util.isInteger(message.targetBitRate)) return 'targetBitRate: integer expected'
    if (message.packetsPerFragment != null && message.hasOwnProperty('packetsPerFragment'))
      if (!$util.isInteger(message.packetsPerFragment)) return 'packetsPerFragment: integer expected'
    if (message.samplesPerPacket != null && message.hasOwnProperty('samplesPerPacket'))
      if (!$util.isInteger(message.samplesPerPacket)) return 'samplesPerPacket: integer expected'
    if (message.sampleFormat != null && message.hasOwnProperty('sampleFormat'))
      if (!$util.isString(message.sampleFormat)) return 'sampleFormat: string expected'
    if (message.numChannels != null && message.hasOwnProperty('numChannels'))
      if (!$util.isInteger(message.numChannels)) return 'numChannels: integer expected'
    return null
  }
  ...
  OutputCoding.fromObject = function fromObject(object) {
    if (object instanceof $root.OutputCoding) return object
    var message = new $root.OutputCoding()
    if (object.container != null) message.container = String(object.container)
    if (object.codec != null) message.codec = String(object.codec)
    if (object.targetSampleRate != null) message.targetSampleRate = object.targetSampleRate >>> 0
    if (object.targetBitRate != null) message.targetBitRate = object.targetBitRate >>> 0
    if (object.packetsPerFragment != null) message.packetsPerFragment = object.packetsPerFragment >>> 0
    if (object.samplesPerPacket != null) message.samplesPerPacket = object.samplesPerPacket >>> 0
    if (object.sampleFormat != null) message.sampleFormat = String(object.sampleFormat)
    if (object.numChannels != null) message.numChannels = object.numChannels >>> 0
    return message
  }
  ...
  OutputCoding.toObject = function toObject(message, options) {
    ...
    if (message.container != null && message.hasOwnProperty('container')) object.container = message.container
    if (message.codec != null && message.hasOwnProperty('codec')) object.codec = message.codec
    if (message.targetSampleRate != null && message.hasOwnProperty('targetSampleRate'))
    ...
    if (message.numChannels != null && message.hasOwnProperty('numChannels')) object.numChannels = message.numChannels
    return object
  }
...
$root.InsertSpec = (function() {
  ...
  InsertSpec.encode = function encode(message, writer) {
    ...
    if (message.inputChannels != null && message.inputChannels.length) {
      ...
      for (var i = 0; i < message.inputChannels.length; ++i) writer.uint32(message.inputChannels[i])
      writer.ldelim()
    }
    if (message.outputChannels != null && message.outputChannels.length) {
      writer.uint32(/* id 3, wireType 2 =*/ 26).fork()
      for (var i = 0; i < message.outputChannels.length; ++i) writer.uint32(message.outputChannels[i])
      writer.ldelim()
    }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break
        case 2:
          if (!(message.inputChannels && message.inputChannels.length)) message.inputChannels = []
          if ((tag & 7) === 2) {
            var end2 = reader.uint32() + reader.pos
            while (reader.pos < end2) message.inputChannels.push(reader.uint32())
          } else message.inputChannels.push(reader.uint32())
          break
        case 3:
          if (!(message.outputChannels && message.outputChannels.length)) message.outputChannels = []
          if ((tag & 7) === 2) {
            var end2 = reader.uint32() + reader.pos
            while (reader.pos < end2) message.outputChannels.push(reader.uint32())
          } else message.outputChannels.push(reader.uint32())
          break
        case 4:
  ...
  InsertSpec.verify = function verify(message) {
    if (typeof message !== 'object' || message === null) return 'object expected'
    if (message.endpoint != null && message.hasOwnProperty('endpoint'))
      if (!$util.isString(message.endpoint)) return 'endpoint: string expected'
    if (message.inputChannels != null && message.hasOwnProperty('inputChannels')) {
      if (!Array.isArray(message.inputChannels)) return 'inputChannels: array expected'
      for (var i = 0; i < message.inputChannels.length; ++i)
        if (!$util.isInteger(message.inputChannels[i])) return 'inputChannels: integer[] expected'
    }
    if (message.outputChannels != null && message.hasOwnProperty('outputChannels')) {
      if (!Array.isArray(message.outputChannels)) return 'outputChannels: array expected'
      for (var i = 0; i < message.outputChannels.length; ++i)
        if (!$util.isInteger(message.outputChannels[i])) return 'outputChannels: integer[] expected'
    }
    if (message.additionalLatency != null && message.hasOwnProperty('additionalLatency'))
      if (!$util.isInteger(message.additionalLatency)) return 'additionalLatency: integer expected'
    if (message.enableDryWet != null && message.hasOwnProperty('enableDryWet'))
      if (typeof message.enableDryWet !== 'boolean') return 'enableDryWet: boolean expected'
    if (message.enableFFT != null && message.hasOwnProperty('enableFFT'))
      if (typeof message.enableFFT !== 'boolean') return 'enableFFT: boolean expected'
    if (message.sampleRate != null && message.hasOwnProperty('sampleRate'))
  ...
  InsertSpec.fromObject = function fromObject(object) {
    if (object instanceof $root.InsertSpec) return object
    var message = new $root.InsertSpec()
    if (object.endpoint != null) message.endpoint = String(object.endpoint)
    if (object.inputChannels) {
      if (!Array.isArray(object.inputChannels)) throw TypeError('.InsertSpec.inputChannels: array expected')
      message.inputChannels = []
      for (var i = 0; i < object.inputChannels.length; ++i) message.inputChannels[i] = object.inputChannels[i] >>> 0
    }
    if (object.outputChannels) {
      if (!Array.isArray(object.outputChannels)) throw TypeError('.InsertSpec.outputChannels: array expected')
      message.outputChannels = []
      for (var i = 0; i < object.outputChannels.length; ++i) message.outputChannels[i] = object.outputChannels[i] >>> 0
    }
    if (object.additionalLatency != null) message.additionalLatency = object.additionalLatency >>> 0
    if (object.enableDryWet != null) message.enableDryWet = Boolean(object.enableDryWet)
    if (object.enableFFT != null) message.enableFFT = Boolean(object.enableFFT)
  ...
  InsertSpec.toObject = function toObject(message, options) {
    ...
    if (message.endpoint != null && message.hasOwnProperty('endpoint')) object.endpoint = message.endpoint
    if (message.inputChannels && message.inputChannels.length) {
      object.inputChannels = []
      for (var j = 0; j < message.inputChannels.length; ++j) object.inputChannels[j] = message.inputChannels[j]
    }
    if (message.outputChannels && message.outputChannels.length) {
      object.outputChannels = []
      for (var j = 0; j < message.outputChannels.length; ++j) object.outputChannels[j] = message.outputChannels[j]
    }
    if (message.additionalLatency != null && message.hasOwnProperty('additionalLatency'))
      object.additionalLatency = message.additionalLatency
    if (message.enableDryWet != null && message.hasOwnProperty('enableDryWet'))
      object.enableDryWet = message.enableDryWet
    if (message.enableFFT != null && message.hasOwnProperty('enableFFT')) object.enableFFT = message.enableFFT
    if (message.sampleRate != null && message.hasOwnProperty('sampleRate')) object.sampleRate = message.sampleRate
    if (message.bufferSize != null && message.hasOwnProperty('bufferSize')) object.bufferSize = message.bufferSize
    return object
  }
...
$root.PluginSpec = (function() {
  ...
  PluginSpec.fromObject = function fromObject(object) {
    if (object instanceof $root.PluginSpec) return object
  ...
  PluginSpec.toObject = function toObject(message, options) {
    ...
    if (message.plugin != null && message.hasOwnProperty('plugin')) object.plugin = message.plugin
    if (message.additionalLatency != null && message.hasOwnProperty('additionalLatency'))
      object.additionalLatency = message.additionalLatency
    return object
  }
...
$root.ProcessorSpec = (function() {
  ...
  ProcessorSpec.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.ProcessorSpec()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  ProcessorSpec.verify = function verify(message) {
    ...
    if (message.insert != null && message.hasOwnProperty('insert')) {
      properties.spec = 1
      {
        ...
        if (error) return 'insert.' + error
      }
    }
    if (message.plugin != null && message.hasOwnProperty('plugin')) {
      if (properties.spec === 1) return 'spec: multiple values'
      properties.spec = 1
      {
        var error = $root.PluginSpec.verify(message.plugin)
        if (error) return 'plugin.' + error
      }
    }
    return null
  }
  ...
  ProcessorSpec.fromObject = function fromObject(object) {
    if (object instanceof $root.ProcessorSpec) return object
    var message = new $root.ProcessorSpec()
    if (object.insert != null) {
      if (typeof object.insert !== 'object') throw TypeError('.ProcessorSpec.insert: object expected')
      message.insert = $root.InsertSpec.fromObject(object.insert)
    }
    if (object.plugin != null) {
      if (typeof object.plugin !== 'object') throw TypeError('.ProcessorSpec.plugin: object expected')
  ...
  ProcessorSpec.toObject = function toObject(message, options) {
    ...
    if (message.insert != null && message.hasOwnProperty('insert')) {
      ...
      if (options.oneofs) object.spec = 'insert'
    }
    if (message.plugin != null && message.hasOwnProperty('plugin')) {
      object.plugin = $root.PluginSpec.toObject(message.plugin, options)
      if (options.oneofs) object.spec = 'plugin'
    }
    return object
  }
...
$root.Input = (function() {
  ...
  Input.verify = function verify(message) {
    ...
    if (message.startPos != null && message.hasOwnProperty('startPos'))
      if (typeof message.startPos !== 'number') return 'startPos: number expected'
    if (message.endPos != null && message.hasOwnProperty('endPos'))
      if (typeof message.endPos !== 'number') return 'endPos: number expected'
    return null
  }
  ...
  Input.fromObject = function fromObject(object) {
    ...
    if (object.startPos != null) message.startPos = Number(object.startPos)
    if (object.endPos != null) message.endPos = Number(object.endPos)
    return message
  }
...
$root.Measurement = (function() {
  ...
  Measurement.encode = function encode(message, writer) {
    ...
    if (message.measurement != null && message.measurement.length) {
      writer.uint32(/* id 3, wireType 2 =*/ 26).fork()
      for (var i = 0; i < message.measurement.length; ++i) writer.double(message.measurement[i])
      writer.ldelim()
    }
    return writer
  }
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2:
          ...
          break
        case 3:
          if (!(message.measurement && message.measurement.length)) message.measurement = []
          if ((tag & 7) === 2) {
            var end2 = reader.uint32() + reader.pos
            while (reader.pos < end2) message.measurement.push(reader.double())
          } else message.measurement.push(reader.double())
          break
        default:
          reader.skipType(tag & 7)
          break
  ...
  Measurement.verify = function verify(message) {
    if (typeof message !== 'object' || message === null) return 'object expected'
    if (message.sampleRate != null && message.hasOwnProperty('sampleRate'))
      if (typeof message.sampleRate !== 'number') return 'sampleRate: number expected'
    if (message.name != null && message.hasOwnProperty('name'))
      if (!$util.isString(message.name)) return 'name: string expected'
    if (message.measurement != null && message.hasOwnProperty('measurement')) {
      if (!Array.isArray(message.measurement)) return 'measurement: array expected'
      for (var i = 0; i < message.measurement.length; ++i)
        if (typeof message.measurement[i] !== 'number') return 'measurement: number[] expected'
    }
    return null
  }
  ...
  Measurement.fromObject = function fromObject(object) {
    if (object instanceof $root.Measurement) return object
    var message = new $root.Measurement()
    if (object.sampleRate != null) message.sampleRate = Number(object.sampleRate)
    if (object.name != null) message.name = String(object.name)
    if (object.measurement) {
      if (!Array.isArray(object.measurement)) throw TypeError('.Measurement.measurement: array expected')
      message.measurement = []
      for (var i = 0; i < object.measurement.length; ++i) message.measurement[i] = Number(object.measurement[i])
    }
    return message
  }
  ...
  Measurement.toObject = function toObject(message, options) {
    if (!options) options = {}
    var object = {}
    if (options.arrays || options.defaults) object.measurement = []
    if (options.defaults) {
      object.sampleRate = 0
      object.name = ''
    }
    if (message.sampleRate != null && message.hasOwnProperty('sampleRate'))
      object.sampleRate =
        options.json && !isFinite(message.sampleRate) ? String(message.sampleRate) : message.sampleRate
    if (message.name != null && message.hasOwnProperty('name')) object.name = message.name
    if (message.measurement && message.measurement.length) {
      object.measurement = []
      for (var j = 0; j < message.measurement.length; ++j)
        object.measurement[j] =
          options.json && !isFinite(message.measurement[j]) ? String(message.measurement[j]) : message.measurement[j]
    }
    return object
  }
...
$root.Ready = (function() {
  ...
  Ready.fromObject = function fromObject(object) {
    if (object instanceof $root.Ready) return object
...
$root.AudioReady = (function() {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break
        case 2:
          if (!(message.measurements && message.measurements.length)) message.measurements = []
  ...
  AudioReady.verify = function verify(message) {
    ...
    if (message.measurements != null && message.hasOwnProperty('measurements')) {
      if (!Array.isArray(message.measurements)) return 'measurements: array expected'
      for (var i = 0; i < message.measurements.length; ++i) {
    ...
    if (message.sampleTime != null && message.hasOwnProperty('sampleTime'))
      if (
        !$util.isInteger(message.sampleTime) &&
        !(message.sampleTime && $util.isInteger(message.sampleTime.low) && $util.isInteger(message.sampleTime.high))
      )
        return 'sampleTime: integer|Long expected'
    if (message.haveMore != null && message.hasOwnProperty('haveMore'))
      if (typeof message.haveMore !== 'boolean') return 'haveMore: boolean expected'
    return null
  }
  ...
  AudioReady.fromObject = function fromObject(object) {
    if (object instanceof $root.AudioReady) return object
    ...
    if (object.measurements) {
      if (!Array.isArray(object.measurements)) throw TypeError('.AudioReady.measurements: array expected')
      message.measurements = []
      for (var i = 0; i < object.measurements.length; ++i) {
        if (typeof object.measurements[i] !== 'object') throw TypeError('.AudioReady.measurements: object expected')
    ...
    if (object.sampleTime != null)
      if ($util.Long) (message.sampleTime = $util.Long.fromValue(object.sampleTime)).unsigned = true
      else if (typeof object.sampleTime === 'string') message.sampleTime = parseInt(object.sampleTime, 10)
      else if (typeof object.sampleTime === 'number') message.sampleTime = object.sampleTime
      else if (typeof object.sampleTime === 'object')
        message.sampleTime = new $util.LongBits(object.sampleTime.low >>> 0, object.sampleTime.high >>> 0).toNumber(
          true,
        )
    if (object.haveMore != null) message.haveMore = Boolean(object.haveMore)
    return message
  }
  ...
  AudioReady.toObject = function toObject(message, options) {
    if (!options) options = {}
    var object = {}
    if (options.arrays || options.defaults) object.measurements = []
    if (options.defaults) {
      ...
      } else object.sampleTime = options.longs === String ? '0' : 0
      ...
      if (typeof message.sampleTime === 'number')
        ...
        object.sampleTime =
          options.longs === String
            ? $util.Long.prototype.toString.call(message.sampleTime)
            : options.longs === Number
              ? new $util.LongBits(message.sampleTime.low >>> 0, message.sampleTime.high >>> 0).toNumber(true)
              : message.sampleTime
    if (message.haveMore != null && message.hasOwnProperty('haveMore')) object.haveMore = message.haveMore
    return object
  }
...
$root.SettingValue = (function() {
  ...
  SettingValue.verify = function verify(message) {
    if (typeof message !== 'object' || message === null) return 'object expected'
    if (message.processor != null && message.hasOwnProperty('processor'))
      if (!$util.isString(message.processor)) return 'processor: string expected'
    if (message.parameter != null && message.hasOwnProperty('parameter'))
  ...
  SettingValue.fromObject = function fromObject(object) {
    if (object instanceof $root.SettingValue) return object
    var message = new $root.SettingValue()
    if (object.processor != null) message.processor = String(object.processor)
  ...
  SettingValue.toObject = function toObject(message, options) {
    ...
    if (message.processor != null && message.hasOwnProperty('processor')) object.processor = message.processor
...
$root.SetSettings = (function() {
  ...
  SetSettings.fromObject = function fromObject(object) {
    if (object instanceof $root.SetSettings) return object
    var message = new $root.SetSettings()
    if (object.settings) {
      if (!Array.isArray(object.settings)) throw TypeError('.SetSettings.settings: array expected')
      message.settings = []
      for (var i = 0; i < object.settings.length; ++i) {
        if (typeof object.settings[i] !== 'object') throw TypeError('.SetSettings.settings: object expected')
...
$root.Terminate = (function() {
  ...
  Terminate.fromObject = function fromObject(object) {
    if (object instanceof $root.Terminate) return object
...
$root.Terminated = (function() {
  ...
  Terminated.fromObject = function fromObject(object) {
    if (object instanceof $root.Terminated) return object
...
$root.Connection = (function() {
  ...
  Connection.verify = function verify(message) {
    if (typeof message !== 'object' || message === null) return 'object expected'
    if (message.fromNode != null && message.hasOwnProperty('fromNode'))
      if (!$util.isString(message.fromNode)) return 'fromNode: string expected'
    if (message.fromPad != null && message.hasOwnProperty('fromPad'))
      if (!$util.isString(message.fromPad)) return 'fromPad: string expected'
    if (message.toNode != null && message.hasOwnProperty('toNode'))
      if (!$util.isString(message.toNode)) return 'toNode: string expected'
    if (message.toPad != null && message.hasOwnProperty('toPad'))
      if (!$util.isString(message.toPad)) return 'toPad: string expected'
    return null
  }
  ...
  Connection.fromObject = function fromObject(object) {
    if (object instanceof $root.Connection) return object
    var message = new $root.Connection()
    if (object.fromNode != null) message.fromNode = String(object.fromNode)
    if (object.fromPad != null) message.fromPad = String(object.fromPad)
    if (object.toNode != null) message.toNode = String(object.toNode)
    if (object.toPad != null) message.toPad = String(object.toPad)
    return message
  }
  ...
  Connection.toObject = function toObject(message, options) {
    ...
    if (message.fromNode != null && message.hasOwnProperty('fromNode')) object.fromNode = message.fromNode
    if (message.fromPad != null && message.hasOwnProperty('fromPad')) object.fromPad = message.fromPad
    if (message.toNode != null && message.hasOwnProperty('toNode')) object.toNode = message.toNode
    if (message.toPad != null && message.hasOwnProperty('toPad')) object.toPad = message.toPad
    return object
  }
...
$root.Play = (function() {
    ...
    if (message.inputs != null && message.hasOwnProperty('inputs'))
      for (var keys = Object.keys(message.inputs), i = 0; i < keys.length; ++i) {
        writer
          ...
          .uint32(/* id 1, wireType 2 =*/ 10)
          .string(keys[i])
        $root.Input.encode(message.inputs[keys[i]], writer.uint32(/* id 2, wireType 2 =*/ 18).fork())
          .ldelim()
          .ldelim()
      }
    ...
    if (message.processors != null && message.hasOwnProperty('processors'))
      for (var keys = Object.keys(message.processors), i = 0; i < keys.length; ++i) {
        writer
          ...
          .uint32(/* id 1, wireType 2 =*/ 10)
          .string(keys[i])
        $root.ProcessorSpec.encode(message.processors[keys[i]], writer.uint32(/* id 2, wireType 2 =*/ 18).fork())
          .ldelim()
          .ldelim()
      }
  ...
  Play.decode = function decode(reader, length) {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 3:
          reader.skip().pos++
          if (message.processors === $util.emptyObject) message.processors = {}
          key = reader.string()
          reader.pos++
  ...
  Play.verify = function verify(message) {
    ...
    if (message.processors != null && message.hasOwnProperty('processors')) {
      if (!$util.isObject(message.processors)) return 'processors: object expected'
      var key = Object.keys(message.processors)
      for (var i = 0; i < key.length; ++i) {
        var error = $root.ProcessorSpec.verify(message.processors[key[i]])
        if (error) return 'processors.' + error
      }
    }
    if (message.output != null && message.hasOwnProperty('output')) {
  ...
  Play.fromObject = function fromObject(object) {
    if (object instanceof $root.Play) return object
    var message = new $root.Play()
    if (object.inputs) {
      if (typeof object.inputs !== 'object') throw TypeError('.Play.inputs: object expected')
      message.inputs = {}
      for (var keys = Object.keys(object.inputs), i = 0; i < keys.length; ++i) {
        if (typeof object.inputs[keys[i]] !== 'object') throw TypeError('.Play.inputs: object expected')
        message.inputs[keys[i]] = $root.Input.fromObject(object.inputs[keys[i]])
      }
    }
    if (object.processors) {
      if (typeof object.processors !== 'object') throw TypeError('.Play.processors: object expected')
      message.processors = {}
      for (var keys = Object.keys(object.processors), i = 0; i < keys.length; ++i) {
        if (typeof object.processors[keys[i]] !== 'object') throw TypeError('.Play.processors: object expected')
        message.processors[keys[i]] = $root.ProcessorSpec.fromObject(object.processors[keys[i]])
      }
    }
    if (object.output != null) {
      if (typeof object.output !== 'object') throw TypeError('.Play.output: object expected')
      message.output = $root.OutputCoding.fromObject(object.output)
    }
    if (object.flow) {
      if (!Array.isArray(object.flow)) throw TypeError('.Play.flow: array expected')
      message.flow = []
      for (var i = 0; i < object.flow.length; ++i) {
        if (typeof object.flow[i] !== 'object') throw TypeError('.Play.flow: object expected')
        message.flow[i] = $root.Connection.fromObject(object.flow[i])
      }
    }
    if (object.settings != null) {
      if (typeof object.settings !== 'object') throw TypeError('.Play.settings: object expected')
  ...
  Play.toObject = function toObject(message, options) {
    ...
    if (message.flow && message.flow.length) {
      object.flow = []
      for (var j = 0; j < message.flow.length; ++j) object.flow[j] = $root.Connection.toObject(message.flow[j], options)
    }
    if (message.settings != null && message.hasOwnProperty('settings'))
...
$root.ErrorOrWarning = (function() {
  ...
  ErrorOrWarning.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.ErrorOrWarning()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  ErrorOrWarning.verify = function verify(message) {
    ...
    if (message.warning != null && message.hasOwnProperty('warning')) {
      ...
      if (!$util.isString(message.warning)) return 'warning: string expected'
    }
    if (message.error != null && message.hasOwnProperty('error')) {
  ...
  ErrorOrWarning.fromObject = function fromObject(object) {
    if (object instanceof $root.ErrorOrWarning) return object
    var message = new $root.ErrorOrWarning()
    if (object.warning != null) message.warning = String(object.warning)
  ...
  ErrorOrWarning.toObject = function toObject(message, options) {
    ...
    if (message.warning != null && message.hasOwnProperty('warning')) {
      ...
      if (options.oneofs) object.message = 'warning'
    }
    if (message.error != null && message.hasOwnProperty('error')) {
      object.error = message.error
      if (options.oneofs) object.message = 'error'
    }
    return object
  }
...
$root.Event = (function() {
  ...
  Event.verify = function verify(message) {
    ...
    if (message.audioReady != null && message.hasOwnProperty('audioReady')) {
      ...
      properties.message = 1
      {
        ...
        if (error) return 'audioReady.' + error
      }
    }
    if (message.terminated != null && message.hasOwnProperty('terminated')) {
      if (properties.message === 1) return 'message: multiple values'
      properties.message = 1
      {
        ...
        if (error) return 'terminated.' + error
      }
    }
    if (message.errorOrWarning != null && message.hasOwnProperty('errorOrWarning')) {
      if (properties.message === 1) return 'message: multiple values'
      properties.message = 1
      {
        ...
        if (error) return 'errorOrWarning.' + error
      }
    }
    return null
  }
  ...
  Event.fromObject = function fromObject(object) {
    ...
    if (object.ready != null) {
      if (typeof object.ready !== 'object') throw TypeError('.Event.ready: object expected')
      message.ready = $root.Ready.fromObject(object.ready)
    }
    if (object.audioReady != null) {
      if (typeof object.audioReady !== 'object') throw TypeError('.Event.audioReady: object expected')
      message.audioReady = $root.AudioReady.fromObject(object.audioReady)
    }
    if (object.terminated != null) {
      if (typeof object.terminated !== 'object') throw TypeError('.Event.terminated: object expected')
      message.terminated = $root.Terminated.fromObject(object.terminated)
    }
    if (object.errorOrWarning != null) {
      if (typeof object.errorOrWarning !== 'object') throw TypeError('.Event.errorOrWarning: object expected')
...
$root.Request = (function() {
  ...
  Request.verify = function verify(message) {
    ...
    if (message.setSettings != null && message.hasOwnProperty('setSettings')) {
      ...
      properties.command = 1
      {
        ...
        if (error) return 'setSettings.' + error
      }
    }
    return null
  }
  ...
  Request.fromObject = function fromObject(object) {
    ...
    if (object.play != null) {
      if (typeof object.play !== 'object') throw TypeError('.Request.play: object expected')
      message.play = $root.Play.fromObject(object.play)
    }
    if (object.terminate != null) {
      if (typeof object.terminate !== 'object') throw TypeError('.Request.terminate: object expected')
      message.terminate = $root.Terminate.fromObject(object.terminate)
    }
    if (object.setSettings != null) {
      if (typeof object.setSettings !== 'object') throw TypeError('.Request.setSettings: object expected')
  ...
  Request.toObject = function toObject(message, options) {
    if (!options) options = {}
    var object = {}
    if (options.defaults) object.requestId = ''
...
$root.AudioRuntimeStatus = (function() {
  ...
  AudioRuntimeStatus.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.AudioRuntimeStatus()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        default:
  ...
  AudioRuntimeStatus.fromObject = function fromObject(object) {
    if (object instanceof $root.AudioRuntimeStatus) return object
...
$root.NoParameters = (function() {
  ...
  NoParameters.fromObject = function fromObject(object) {
    if (object instanceof $root.NoParameters) return object
...
$root.ChannelData = (function() {
  ...
  ChannelData.fromObject = function fromObject(object) {
    if (object instanceof $root.ChannelData) return object
...
$root.ExchangeChannels = (function() {
  ...
  ExchangeChannels.encode = function encode(message, writer) {
    ...
    if (message.requestChannels != null && message.requestChannels.length) {
      writer.uint32(/* id 2, wireType 2 =*/ 18).fork()
      for (var i = 0; i < message.requestChannels.length; ++i) writer.uint32(message.requestChannels[i])
      writer.ldelim()
    }
    return writer
  }
  ...
  ExchangeChannels.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.ExchangeChannels()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
          ...
          break
        case 2:
          if (!(message.requestChannels && message.requestChannels.length)) message.requestChannels = []
          if ((tag & 7) === 2) {
            var end2 = reader.uint32() + reader.pos
            while (reader.pos < end2) message.requestChannels.push(reader.uint32())
          } else message.requestChannels.push(reader.uint32())
          break
        default:
          reader.skipType(tag & 7)
          break
  ...
  ExchangeChannels.verify = function verify(message) {
    ...
    if (message.requestChannels != null && message.hasOwnProperty('requestChannels')) {
      if (!Array.isArray(message.requestChannels)) return 'requestChannels: array expected'
      for (var i = 0; i < message.requestChannels.length; ++i)
        if (!$util.isInteger(message.requestChannels[i])) return 'requestChannels: integer[] expected'
    }
    return null
  }
  ...
  ExchangeChannels.fromObject = function fromObject(object) {
    if (object instanceof $root.ExchangeChannels) return object
    var message = new $root.ExchangeChannels()
    if (object.channels) {
      if (!Array.isArray(object.channels)) throw TypeError('.ExchangeChannels.channels: array expected')
      message.channels = []
      for (var i = 0; i < object.channels.length; ++i) {
        if (typeof object.channels[i] !== 'object') throw TypeError('.ExchangeChannels.channels: object expected')
        message.channels[i] = $root.ChannelData.fromObject(object.channels[i])
      }
    }
    if (object.requestChannels) {
      if (!Array.isArray(object.requestChannels)) throw TypeError('.ExchangeChannels.requestChannels: array expected')
  ...
  ExchangeChannels.toObject = function toObject(message, options) {
    ...
    if (message.requestChannels && message.requestChannels.length) {
      object.requestChannels = []
      for (var j = 0; j < message.requestChannels.length; ++j) object.requestChannels[j] = message.requestChannels[j]
    }
    return object
  }
...
$root.ProvideChannels = (function() {
  ...
  ProvideChannels.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.ProvideChannels()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  ProvideChannels.fromObject = function fromObject(object) {
    if (object instanceof $root.ProvideChannels) return object
    var message = new $root.ProvideChannels()
    if (object.channels) {
      if (!Array.isArray(object.channels)) throw TypeError('.ProvideChannels.channels: array expected')
      message.channels = []
      for (var i = 0; i < object.channels.length; ++i) {
        if (typeof object.channels[i] !== 'object') throw TypeError('.ProvideChannels.channels: object expected')
        message.channels[i] = $root.ChannelData.fromObject(object.channels[i])
      }
    }
    return message
...
$root.PublicRequest = (function() {
  ...
  PublicRequest.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.PublicRequest()
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
        case 1:
  ...
  PublicRequest.fromObject = function fromObject(object) {
    if (object instanceof $root.PublicRequest) return object
    var message = new $root.PublicRequest()
    if (object.requestId != null) message.requestId = String(object.requestId)
    if (object.play != null) {
      if (typeof object.play !== 'object') throw TypeError('.PublicRequest.play: object expected')
      message.play = $root.PublicPlay.fromObject(object.play)
    }
    if (object.stop != null) {
      if (typeof object.stop !== 'object') throw TypeError('.PublicRequest.stop: object expected')
      message.stop = $root.PublicStop.fromObject(object.stop)
    }
    if (object.setSettings != null) {
      if (typeof object.setSettings !== 'object') throw TypeError('.PublicRequest.setSettings: object expected')
      message.setSettings = $root.SetSettings.fromObject(object.setSettings)
    }
    if (object.download != null) {
      if (typeof object.download !== 'object') throw TypeError('.PublicRequest.download: object expected')
  ...
  PublicRequest.toObject = function toObject(message, options) {
    ...
    if (message.play != null && message.hasOwnProperty('play')) {
      ...
      if (options.oneofs) object.message = 'play'
    }
    if (message.stop != null && message.hasOwnProperty('stop')) {
      object.stop = $root.PublicStop.toObject(message.stop, options)
      if (options.oneofs) object.message = 'stop'
    }
    if (message.setSettings != null && message.hasOwnProperty('setSettings')) {
      object.setSettings = $root.SetSettings.toObject(message.setSettings, options)
      if (options.oneofs) object.message = 'setSettings'
    }
    if (message.download != null && message.hasOwnProperty('download')) {
      object.download = $root.PublicDownload.toObject(message.download, options)
      if (options.oneofs) object.message = 'download'
    }
    return object
  }
...
$root.PublicStop = (function() {
  ...
  PublicStop.fromObject = function fromObject(object) {
    if (object instanceof $root.PublicStop) return object
...
$root.PublicPlay = (function() {
    ...
    if (message.inputs != null && message.hasOwnProperty('inputs'))
      for (var keys = Object.keys(message.inputs), i = 0; i < keys.length; ++i) {
        writer
          ...
          .uint32(/* id 1, wireType 2 =*/ 10)
          .string(keys[i])
        $root.PublicInput.encode(message.inputs[keys[i]], writer.uint32(/* id 2, wireType 2 =*/ 18).fork())
          .ldelim()
          .ldelim()
      }
  ...
  PublicPlay.verify = function verify(message) {
    ...
    if (message.outputCodingPreset != null && message.hasOwnProperty('outputCodingPreset'))
      if (!$util.isString(message.outputCodingPreset)) return 'outputCodingPreset: string expected'
    if (message.settings != null && message.hasOwnProperty('settings')) {
      var error = $root.SetSettings.verify(message.settings)
      if (error) return 'settings.' + error
    }
    if (message.sampleRate != null && message.hasOwnProperty('sampleRate'))
      if (!$util.isInteger(message.sampleRate)) return 'sampleRate: integer expected'
    if (message.latencyMultiplier != null && message.hasOwnProperty('latencyMultiplier'))
      if (!$util.isInteger(message.latencyMultiplier)) return 'latencyMultiplier: integer expected'
    return null
  }
  ...
  PublicPlay.fromObject = function fromObject(object) {
    if (object instanceof $root.PublicPlay) return object
    var message = new $root.PublicPlay()
    if (object.inputs) {
      if (typeof object.inputs !== 'object') throw TypeError('.PublicPlay.inputs: object expected')
      message.inputs = {}
      for (var keys = Object.keys(object.inputs), i = 0; i < keys.length; ++i) {
        if (typeof object.inputs[keys[i]] !== 'object') throw TypeError('.PublicPlay.inputs: object expected')
        message.inputs[keys[i]] = $root.PublicInput.fromObject(object.inputs[keys[i]])
      }
    }
    if (object.outputCodingPreset != null) message.outputCodingPreset = String(object.outputCodingPreset)
    if (object.settings != null) {
      if (typeof object.settings !== 'object') throw TypeError('.PublicPlay.settings: object expected')
      message.settings = $root.SetSettings.fromObject(object.settings)
    }
    if (object.sampleRate != null) message.sampleRate = object.sampleRate >>> 0
    if (object.latencyMultiplier != null) message.latencyMultiplier = object.latencyMultiplier >>> 0
    return message
  }
  ...
  PublicPlay.toObject = function toObject(message, options) {
    if (!options) options = {}
    var object = {}
    if (options.objects || options.defaults) object.inputs = {}
    if (options.defaults) {
...
$root.PublicInput = (function() {
  ...
  PublicInput.fromObject = function fromObject(object) {
    if (object instanceof $root.PublicInput) return object
  ...
  PublicInput.toObject = function toObject(message, options) {
    ...
    if (message.mediaId != null && message.hasOwnProperty('mediaId')) object.mediaId = message.mediaId
    if (message.startPos != null && message.hasOwnProperty('startPos'))
      object.startPos = options.json && !isFinite(message.startPos) ? String(message.startPos) : message.startPos
    if (message.endPos != null && message.hasOwnProperty('endPos'))
      object.endPos = options.json && !isFinite(message.endPos) ? String(message.endPos) : message.endPos
...
$root.PublicDownload = (function() {
  ...
  PublicDownload.decode = function decode(reader, length) {
    if (!(reader instanceof $Reader)) reader = $Reader.create(reader)
    var end = length === undefined ? reader.len : reader.pos + length,
      message = new $root.PublicDownload(),
      key
    while (reader.pos < end) {
      var tag = reader.uint32()
      switch (tag >>> 3) {
  ...
  PublicDownload.verify = function verify(message) {
    ...
    if (message.downloadCodingPreset != null && message.hasOwnProperty('downloadCodingPreset'))
      if (!$util.isString(message.downloadCodingPreset)) return 'downloadCodingPreset: string expected'
    if (message.settings != null && message.hasOwnProperty('settings')) {
      var error = $root.SetSettings.verify(message.settings)
      if (error) return 'settings.' + error
    }
  ...
  PublicDownload.fromObject = function fromObject(object) {
    if (object instanceof $root.PublicDownload) return object
    var message = new $root.PublicDownload()
    if (object.inputs) {
      if (typeof object.inputs !== 'object') throw TypeError('.PublicDownload.inputs: object expected')
      message.inputs = {}
      for (var keys = Object.keys(object.inputs), i = 0; i < keys.length; ++i) {
        if (typeof object.inputs[keys[i]] !== 'object') throw TypeError('.PublicDownload.inputs: object expected')
        message.inputs[keys[i]] = $root.PublicInput.fromObject(object.inputs[keys[i]])
      }
    }
    if (object.downloadCodingPreset != null) message.downloadCodingPreset = String(object.downloadCodingPreset)
    if (object.settings != null) {
      if (typeof object.settings !== 'object') throw TypeError('.PublicDownload.settings: object expected')
      message.settings = $root.SetSettings.fromObject(object.settings)
    }
    return message
  }
...
$root.PublicFrame = (function() {
  ...
  PublicFrame.verify = function verify(message) {
    ...
    if (message.response != null && message.hasOwnProperty('response')) {
      if (properties.frame === 1) return 'frame: multiple values'
      properties.frame = 1
      {
  ...
  PublicFrame.fromObject = function fromObject(object) {
    if (object instanceof $root.PublicFrame) return object
    var message = new $root.PublicFrame()
    if (object.event != null) {
      if (typeof object.event !== 'object') throw TypeError('.PublicFrame.event: object expected')
      message.event = $root.Event.fromObject(object.event)
    }
    if (object.response != null) {
      if (typeof object.response !== 'object') throw TypeError('.PublicFrame.response: object expected')
  ...
  PublicFrame.toObject = function toObject(message, options) {
    ...
    if (message.event != null && message.hasOwnProperty('event')) {
      ...
      if (options.oneofs) object.frame = 'event'
    }
    if (message.response != null && message.hasOwnProperty('response')) {
      object.response = $root.Response.toObject(message.response, options)
      if (options.oneofs) object.frame = 'response'
    }
    return object
  }
